...
@section('conteudo')
    ...
    </svg> | titulo do evento <br>

    <div class="d-flex mb-3 justify-content-between">
        <div class="me-auto p-5"> Fotógrafo do evento | Itens:</div>
    ...
    <section class=" mx-5 justify-content-evenly flex-wrap">
        @forelse ($carrinho as $foto)
            <div class="d-flex p-2 alert alert-secondary">
                <img width="200" height="200" src="{{ Voyager::image($carrinho->thumbnail('medium', 'original')) }}" class=""  alt="...">
                <div class="ms-auto pt-5 ">
                <a class="btn btn-dark btn-social mx-2 " href="#" aria-label="#"><i class="fab fa-trash"></i></a>
                </div>
            </div>
        @empty
