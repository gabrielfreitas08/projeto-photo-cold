                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            {{-- ?php $images = json_decode($dataTypeContent->fotos); ?>
                            @if($images != null)
                                @foreach($images as $image)
                                    <div class="img_settings_container" data-field-name="fotos" style="float:left;padding-right:15px;">
                        ...
                        <input  required type="file" name="fotos[]" multiple="multiple" accept="image/*"> --}}
